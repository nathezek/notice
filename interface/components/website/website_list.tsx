                        ...
                        <AnimatePresence>
                            {hoveredId === site.id && (
                                <motion.div
                                    ...
                                    className="absolute right-full top-0 z-50 mr-4 w-64 rounded-xl border border-neutral-200 bg-white p-2 shadow-xl dark:border-neutral-800 dark:bg-neutral-950"
                                >
                                    {/* Arrow */}
                                    <div className="absolute right-[-6px] top-4 h-3 w-3 rotate-45 border-r border-t border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-950" />
                                    ...
                                    <div className="overflow-hidden rounded-lg">
                                        ...
                                        <div className="p-3">
                                            <h4 className="mb-1 text-sm font-semibold">{site.title}</h4>
